...
distritos <-
  st_read(dsn = "C:/Users/Bryan/OneDrive/Desktop/Procesamiento de Datos/Proyecto/distritos_simplificados.geojson", quiet = TRUE) %>%
  st_transform(4326)
```

```{r datos-delitos, message=FALSE, warning=FALSE}
delitos <- read_xls(path="C:/Users/Bryan/OneDrive/Desktop/Procesamiento de Datos/Proyecto/estadisticaspoliciales2021.xls")
...
renderPlotly({
  ...
  geom_bar(stat = "identity", fill = "#1C86EE") +
...
grafico_barras_apiladas_proporciones <-
  ...
  ylab("Proporción") +
  labs(fill = "Género") +
  scale_fill_manual(values = c("#1C86EE", "#1874CD", "#104E8B")) +
  dark_theme_gray() +
  theme(legend.position = "top")
...
grafico_x_edad <-
  ...
  ylab("Proporción") +
  labs(fill = "EDAD") +
  scale_fill_manual(values = c("#1E90FF", "#1C86EE", "#1874CD", "#104E8B")) +
  dark_theme_gray() +
  theme(legend.position = "top") 
